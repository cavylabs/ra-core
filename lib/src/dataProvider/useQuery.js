...
var useQuery = function (query, options) {
    ...
    var withDeclarativeSideEffectsSupport = options.withDeclarativeSideEffectsSupport, rest = options.rest;
...
}, _a = void 0, JSON = _a[0], _b = _a[1], stringify = _b === void 0 ? ({ query: query, options: rest }) : _b, dataProvider = _a[2], dataProviderWithDeclarativeSideEffects = _a[3], setState = _a[4];
