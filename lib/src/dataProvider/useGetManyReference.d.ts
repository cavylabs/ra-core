 ...
 * };
 */
declare const useGetManyReference: (resource: string, target: string, id: string | number, pagination: Pagination, sort: Sort, filter: any, referencingResource: string, options?: any) => void;
