...
var validateResponseFormat_1 = require('./validateResponseFormat');
var undoableEventEmitter_1 = require('./undoableEventEmitter');
var getFetchType_1 = require('./getFetchType');
...
var useLogoutIfAccessDenied_1 = require('../auth/useLogoutIfAccessDenied');
...
var useDataProvider = function () {
    var dispatch = react_redux_1.useDispatch(), as = redux_1.Dispatch;
        ...
        return new Proxy(dataProvider, {
            get: function (target, name) {
                return function (resource, payload, options) {
                    ...
                    var _a = void 0, _b = _a.action, action = _b === void 0 ? 'CUSTOM_FETCH' : _b, _c = _a.undoable, undoable = _c === void 0 ? false : _c, _d = _a.onSuccess, onSuccess = _d === void 0 ? undefined : _d, _e = _a.onFailure, onFailure = _e === void 0 ? undefined : _e;
                };
            } }, ...rest);
    }, options || {});
...
var performUndoableQuery = function (_a) {
    ...
    dispatch.apply(void 0, [{
        type: action,
        payload: payload,
        meta: { resource: resource } }].concat(rest));
};
;
dispatch({
...
try {
    dataProvider[type](resource, payload)
        ...
        dispatch.apply(void 0, [{
            ...
            meta: {} }].concat(rest, [resource, fetchResponse, getFetchType_1["default"](type), fetchStatus, fetchActions_1.FETCH_END]));
    });
}
finally { }
;
...
catch (error) { }
{
    ...
    return logoutIfAccessDenied(error).then(function (loggedOut) {
        ...
        dispatch.apply(void 0, [{
            ...
            requestPayload: payload,
            meta: {} }].concat(rest, [resource, fetchResponse, getFetchType_1["default"](type), fetchStatus, fetchActions_1.FETCH_ERROR]));
    });
}
;
...
dispatch.apply(void 0, [{
    ...
    payload: response,
    requestPayload: payload,
    meta: {} }].concat(rest, [resource, fetchResponse, getFetchType_1["default"](type), fetchStatus, fetchActions_1.FETCH_END, fromCache, true, ]));
onSuccess && onSuccess(response);
