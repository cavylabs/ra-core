...
var useGetMany = function (resource, ids, options) {
    ...
    if (!isEqual_1["default"](state.data, data)) {
        setState.apply(void 0, [{}].concat(state, [data, loaded, true]));
    }
    ;
};
...
var makeGetManySelector = function () {
    return reselect_1.createSelector(function (state) { return state.admin.resources; }, function (_, resource) { return resource; }, function (_, __, ids) { return ids; }, function (resources, resource, ids) {
        ...
        dataProvider
            ...
            react_dom_1["default"].unstable_batchedUpdates(function () {
                return queries.forEach(function (_a) {
                    var ids = _a.ids, setState = _a.setState, onSuccess = _a.onSuccess;
                    setState.apply(void 0, [function (prevState) { return ({}); }].concat(prevState, [error, null, loading, false, loaded, true]));
                });
            });
        });
        if (onSuccess) {
