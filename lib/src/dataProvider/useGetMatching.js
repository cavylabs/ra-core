...
var useGetMatching = function (resource, pagination, sort, filter, source, referencingResource, options) {
    ...
    var _a = useQueryWithStore_1["default"].apply(void 0, [{
        ...
        resource: resource,
        payload: payload
    }, {}].concat(options, [relatedTo, action, crudGetMatching_1.CRUD_GET_MATCHING])), possibleValues = _a.data, total = _a.total, error = _a.error, loading = _a.loading, loaded = _a.loaded;
};
function (state) {
