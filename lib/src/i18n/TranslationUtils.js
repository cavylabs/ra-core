...
exports.resolveBrowserLocale = function (defaultLocale) {
    ...
    var _a = window.navigator, language = _a.language, browserLanguage = _a.browserLanguage, userLanguage = _a.userLanguage, as = AllNavigatorLanguage;
...
exports.mergeTranslations = function () {
    ...
    for (var _i = 0; _i < arguments.length; _i++) {
        translationsModules[_i - 0] = arguments[_i];
    }
